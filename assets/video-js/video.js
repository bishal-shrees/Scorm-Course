...
(function () {
  ...
  "GENERATED_CDN_VSN" !== u.Rb &&
    (videojs.options.flash.swf =
      u.Fc + "vjs.zencdn.net/" + u.Rb + "/video-js.swf");
  u.va = {};
  ...
  u.ec = function (a, c) {
    ...
    0 === d.z[c].length &&
      ...
      document.removeEventListener
        ? a.removeEventListener(c, d.V, l)
        : document.detachEvent && a.detachEvent("on" + c, d.V));
  ...
  var z = u.J.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i),
    ...
    B;
  z
    ? ((A = z[1] && parseFloat(z[1])),
      (B = z[2] && parseFloat(z[2])),
      (y = A && B ? parseFloat(z[1] + "." + z[2]) : A ? A : h))
    : (y = h);
  ba.Qb = y;
  ...
  u.$b = !!(
    ...
    (window.Gc && document instanceof window.Gc)
  );
  u.wb = function (a) {
    var c, d, e, g;
    c = {};
  ...
  t.Y = function (a, c) {
    ...
    "string" === typeof a
      ? ((e = a),
        (c = c || {}),
        (d = c.componentClass || u.Z(e)),
        (c.name = e),
        (d = new window.videojs[d](this.c || this, c)))
      : (d = a);
    this.K.push(d);
  ...
  u.N.prototype.e = function (a, c) {
    return u.q.prototype.e.call(
      this,
      "li",
      u.l.B({ className: "vjs-menu-item", innerHTML: this.h.label }, c),
    );
  };
  ...
  u.Player = u.b.extend({
    j: function (a, c, d) {
      ...
      this.U("play", function (a) {
        u.k(this.a, { type: "firstplay", target: this.a }) ||
          (a.preventDefault(),
          a.stopPropagation(),
          a.stopImmediatePropagation());
      });
  ...
  function I(a, c, d) {
    a.i &&
      ((a.aa = l),
      a.i.dispose(),
      a.Cb && ((a.Cb = l), clearInterval(a.Ta)),
      a.Db && J(a),
      (a.i = l));
  ...
  t.currentTime = function (a) {
    return a !== b
      ? (L(this, "setCurrentTime", a), this.Db && this.k("timeupdate"), this)
    ...
    a
      ...
      : this.i.Wa()
        ...
        : ((this.gd = f),
          ...
          u.d(document, "keydown", u.bind(this, this.jc)),
  ...
  t.cancelFullScreen = function () {
    ...
    if (a) document[a.ob]();
      ...
      this.i.Wa()
        ...
        : (M(this), this.k("fullscreenchange"));
    return this;
  };
  t.jc = function (a) {
    27 === a.keyCode &&
      (this.isFullScreen() === f ? this.cancelFullScreen() : M(this));
  };
  function M(a) {
    a.gd = l;
  ...
  t.src = function (a) {
    ...
    if (a instanceof Array) {
      ...
      c
        ? ((a = c.source),
          (c = c.i),
          c == this.xa ? this.src(a) : I(this, c, a))
        : (this.a.appendChild(
      ...
      a instanceof Object
        ...
        : ((this.v.src = a),
          this.aa
            ? (L(this, "src", a),
              "auto" == this.h.preload && this.load(),
              this.h.autoplay && this.play())
            : this.I(function () {
                this.src(a);
              }));
    return this;
  ...
  t.loop = function (a) {
    return a !== b
      ? (L(this, "setLoop", a), (this.h.loop = a), this)
      : K(this, "loop");
  };
  t.poster = function (a) {
  ...
  P.Md !== b
    ? ((O.wc = "requestFullscreen"),
      (O.ob = "exitFullscreen"),
      (O.ub = "fullscreenchange"),
      (O.isFullScreen = "fullScreen"))
    : (document.mozCancelFullScreen
        ? ((N = "moz"), (O.isFullScreen = N + "FullScreen"))
        : ((N = "webkit"), (O.isFullScreen = N + "IsFullScreen")),
      P[N + "RequestFullScreen"] &&
        ((O.wc = N + "RequestFullScreen"), (O.ob = N + "CancelFullScreen")),
      (O.ub = N + "fullscreenchange"));
  ...
  u.ab.prototype.da = function () {
    ...
    a &&
      (this.G.innerHTML =
        '<span class="vjs-control-text">Duration Time </span>' + u.ta(a));
  };
  u.bc = u.b.extend({
    j: function (a, c) {
      u.b.call(this, a, c);
  ...
  u.cb.prototype.update = function () {
    this.a.style &&
      (this.a.style.width = u.round(100 * this.c.bufferedPercent(), 2) + "%");
  };
  u.Wb = u.b.extend({
    j: function (a, c) {
      u.b.call(this, a, c);
      ...
      a = function () {
        if (e.controls() && !e.usingNativeControls()) {
          ...
          g.d("touchend", function () {
            n === f &&
              ((d = new Date().getTime() - c), 250 > d && this.k("tap"));
          });
          g.d("tap", g.qd);
        }
      };
  ...
  t.e = function () {
    ...
    if (!c || this.m.movingMediaElementInDOM === l)
      (c
        ? ((d = c.cloneNode(l)), u.g.gc(c), (c = d), (a.M = h))
        : (c = u.e("video", {
            id: a.id() + "_html5_api",
            className: "vjs-tech",
          })),
  ...
  var R,
    fa = /^application\/(?:x-|vnd\.apple\.)mpegurl/i,
    ga = /^video\/mp4/i;
  u.g.rc = function () {
    4 <= u.Qb &&
      (R || (R = u.F.constructor.prototype.canPlayType),
      (u.F.constructor.prototype.canPlayType = function (a) {
      ...
      u.Ub &&
        this.I(function () {
          u.d(
            ...
            "mousemove",
            u.bind(this, function () {
              this.C().k({ type: "mousemove", bubbles: l });
            }),
          );
        });
  ...
  t.src = function (a) {
    ...
    u.f.hd(a)
      ? ((a = u.f.Ac(a)), this.Td(a.qb), this.Ud(a.Mb))
      : ((a = u.kc(a)), this.a.vjs_src(a));
    if (this.c.autoplay()) {
      var c = this;
      setTimeout(function () {
        c.play();
  ...
  t.mode = p("ga");
  t.Qc = function () {
    this.a.style.fontSize = this.c.isFullScreen()
      ? 140 * (screen.width / this.c.width()) + "%"
      : "";
  };
  t.e = function () {
    return u.b.prototype.e.call(this, "div", {
  ...
  function Y(a) {
    0 === a.ha && a.load();
    0 === a.ga &&
      (a.c.d("timeupdate", u.bind(a, a.update, a.R)),
      a.c.d("ended", u.bind(a, a.reset, a.R)),
  ...
  t.load = function () {
    0 === this.ha &&
      ((this.ha = 1),
      u.get(this.xc, u.bind(this, this.rd), u.bind(this, this.Fb)));
  };
  t.Fb = function (a) {
    this.error = a;
    this.ha = 3;
      ...
      if (this.Kb === b || a < this.Kb || this.Oa <= a) {
        ...
        for (;;) {
          ...
          if (n.sa <= a) ((e = Math.max(e, n.sa)), n.Ia && (n.Ia = l));
            ...
            (g
              ? (j.splice(0, 0, n), r === b && (r = s), (k = s))
              : (j.push(n), k === b && (k = s), (r = s)),
              (d = Math.min(d, n.sa)),
  ...
  u.T.prototype.qa = function () {
    ...
    for (var d = 0; d < this.c.textTracks().length; d++)
      ((c = this.c.textTracks()[d]),
        c.H() === this.A && a.push(new u.X(this.c, { track: c })));
    return a;
  };
  u.Ba = u.T.extend({
    j: function (a, c, d) {
  ...
  t.Ma = function () {
    for (
      var a = this.c.textTracks(), c = 0, d = a.length, e, g, j = (this.L = []);
      c < d;
      c++
    )
    ...
    if (g) {
      ...
      for (var k, c = 0, d = e.length; c < d; c++)
        ((k = e[c]),
          (k = new u.Za(this.c, { track: g, cue: k })),
          j.push(k),
          a.Y(k));
    }
      ...
      for (var e = 0, g = d.length; e < g; e++)
        if ((c = d[e]) && c.getAttribute)
          c.player === b &&
            ...
            a !== h && ((a = u.JSON.parse(a || "{}")), videojs(c, a)));
        else {
          u.lb();
          break;
        }
